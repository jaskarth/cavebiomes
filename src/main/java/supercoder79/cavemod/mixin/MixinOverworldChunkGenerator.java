...
import supercoder79.cavemod.Cavemod;
import supercoder79.cavemod.cave.CaveDecorator;
import supercoder79.cavemod.cave.CaveDecorators;
import supercoder79.cavemod.layer.LayerHolder;
import supercoder79.cavemod.magic.CaveAirAccess;
    ...
    public void carve(ChunkRegion world, BiomeAccess biomeAccess, Chunk chunk, GenerationStep.Carver carver) {
        ...
        for(int l = j - 8; l <= j + 8; ++l) {
            for(int m = k - 8; m <= k + 8; ++m) {
                ...
                CaveDecorator decorator = Cavemod.BIOME2CD.getOrDefault(biome, CaveDecorators.NONE);
